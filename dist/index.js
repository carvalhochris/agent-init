...
async function createFiles(data) {
    ...
    await fs.writeFile(path.join(projectDir, 'README.md'), `# ${data.projectName}
...
`);
    await fs.writeFile(path.join(projectDir, 'worklog.md'), `# Worklog
...
`);
    ...
    await fs.writeFile(path.join(projectDir, '.agents/config/primary.json'), JSON.stringify(agentConfig, null, 2));
    await fs.writeFile(path.join(projectDir, '.agents/prompts/system.md'), `# System Prompt
...
async function showSummary(projectPath, projectName) {
